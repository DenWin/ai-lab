...
<!-- GENERATED from ai-artifacts/skills/shared/setup/setup-repo/SKILL.md. Edit ai-artifacts/skills/shared and run scripts/setup-repo.ps1. -->
# Setup Repo
