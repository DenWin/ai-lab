...
1. ✅ skills README: paths corrected to `ai-artifacts/skills/shared/…`, `planning` group added to the group
...
3. ✅ "Not the same file" now owned solely by repo-layout.adoc; instructions/README links to it.
   ...
   `instructions/anthropic/claude-code/` — one more instance of why single-owner matters.
