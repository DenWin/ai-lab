...
title: "caveman"
description: "Ultra-compressed communication mode that cuts filler while preserving technical accuracy."
resource: ./SKILL.md
tags: [session, skill]
upstream-author: mattpocock
upstream-repo: https://github.com/mattpocock/skills
upstream-path: skills/productivity/caveman/SKILL.md
...
- Group: `session`
- Origin: upstream-derived from [https://github.com/mattpocock/skills](https://github.com/mattpocock/skills)
- Upstream path: `skills/productivity/caveman/SKILL.md`
